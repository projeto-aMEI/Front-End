...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">a-mei documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link" >AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-7b4341e8482223bf3ecce7fb39ee97b4"' : 'data-target="#xs-components-links-module-AppModule-7b4341e8482223bf3ecce7fb39ee97b4"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-7b4341e8482223bf3ecce7fb39ee97b4"' :
                                            'id="xs-components-links-module-AppModule-7b4341e8482223bf3ecce7fb39ee97b4"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/DicasComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >DicasComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/MenuFeedComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >MenuFeedComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/MeuPerfilComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >MeuPerfilComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/RegistrarComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >RegistrarComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/SobreNosComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >SobreNosComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/TemaComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >TemaComponent</a>
                                            </li>
                                            <li class="link">
